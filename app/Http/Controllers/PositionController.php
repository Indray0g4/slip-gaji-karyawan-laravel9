...
class PositionController extends Controller
{
    ...
    {
        // bagian tampilan dari data pegawai
        $iduser = Auth::id();
    ...
    {
        // bagian validasi data baru dari data pegawai
        $request->validate([
    ...
    {
        // bagian tampilan dari setiap data pegawai
        $iduser = Auth::id();
    ...
    {
        // bagian mengubah dari setiap data pegawai
        if (Auth::user()->positions->position_name !== "Administrator"){
            abort(403);
        }
        $iduser = Auth::id();
    ...
    {
        // bagian validasi mengubah dari setiap data pegawai
        $request->validate([
            'position_name' => 'required|min:2',
            'division_id' => 'required',
            'salary_id' => 'required',
    ...
    {
        // bagian menghapus dari setiap data pegawai
        $position=Position::find($id);
