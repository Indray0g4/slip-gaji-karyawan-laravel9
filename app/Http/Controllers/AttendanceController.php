...
class AttendanceController extends Controller
{
    ...
    {
        // bagian tampilan dari data karyawan
        $iduser = Auth::id();
    ...
    {
        // bagian menambahkan data karyawan
        $iduser = Auth::id();
        $user_level = Auth::user()->position_id;
        $profile = Profile::where('users_id',$iduser)->first();
        $user_position = Position::where('id',$user_level)->first();
    ...
    {
        // bagian validasi dari memasukkan data karyawan
        $request->validate([
    ...
    {
        // bagian untuk menampilkan dari setiap data karyawan 
        $iduser = Auth::id();
        $user_level = Auth::user()->position_id;
        $profile = Profile::where('users_id',$iduser)->first();
        $user_position = Position::where('id',$user_level)->first();
    ...
    {
        // bagian dari setiap data karyawan yang mau diubah
        $iduser = Auth::id();
        $user_level = Auth::user()->position_id;
        $profile = Profile::where('users_id',$iduser)->first();
        $user_position = Position::where('id',$user_level)->first();
    ...
    {
        // bagian validasi dari setiap data karyawan yyang mau diubah
        $request->validate([
            'attendance_date'=>'required',
            'time_in'=>'required',
            'time_out'=>'required',
    ...
    $attendance->save();
    // jika data karyawan berhasil di ubah
    ...
    {
        // bagian menghapus dari setiap data karyawan
        $attendance= Attendance::find($id);
